namespace Simple.EventStore.Internal.Helpers
{
    ...
    internal readonly struct ObjectMethodExecutorAwaitable
    {
        ...
        {
            this._customAwaitable = customAwaitable;
            this._getAwaiterMethod = getAwaiterMethod;
            this._isCompletedMethod = isCompletedMethod;
            this._getResultMethod = getResultMethod;
            this._onCompletedMethod = onCompletedMethod;
            this._unsafeOnCompletedMethod = unsafeOnCompletedMethod;
        }

        public Awaiter GetAwaiter()
        {
            var customAwaiter = this._getAwaiterMethod(this._customAwaitable);
            return new Awaiter(customAwaiter, this._isCompletedMethod, this._getResultMethod, this._onCompletedMethod, this._unsafeOnCompletedMethod);
        }
        ...
        public readonly struct Awaiter : ICriticalNotifyCompletion
        {
            ...
            public Awaiter(
                ...
                Action<object, Action> unsafeOnCompletedMethod)
            {
                this._customAwaiter = customAwaiter;
                this._isCompletedMethod = isCompletedMethod;
                this._getResultMethod = getResultMethod;
                this._onCompletedMethod = onCompletedMethod;
                this._unsafeOnCompletedMethod = unsafeOnCompletedMethod;
            ...
            public bool IsCompleted => this._isCompletedMethod(this._customAwaiter);

            public object GetResult() => this._getResultMethod(this._customAwaiter);

            public void OnCompleted(Action continuation)
            {
                this._onCompletedMethod(this._customAwaiter, continuation);
            }
            ...
            public void UnsafeOnCompleted(Action continuation)
            {
                ...
                var underlyingMethodToUse = this._unsafeOnCompletedMethod ?? this._onCompletedMethod;
                underlyingMethodToUse(this._customAwaiter, continuation);
            }
        }
    }
}